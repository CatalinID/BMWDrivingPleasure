...
<div id="content2">
<h2>Comentarii &nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp Buna <i><u><?php echo $_SESSION['nume']?></i></u>&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp
 <a href="deconectare.php">Deconectare</a> </h2><br />
<div id="main">
 <p>Aceasta este o sectiune destinata comentariilor unde puteti sa discutati despre un anumit model cu ceilalti.<br />
 Dat fiind faptul ca detineti privilegii de adminstrator,aveti in plus posibilitate de a 
 <a href="delete_all.php"> sterge toate comentariile </a> sau doar un anumit comentariu.<br /><br />
 <span style="font-size:15px">Atentie !!! Folositi un limbaj civilizat !</span></p>
 <form action="comm_logat.php" method="POST">
 <table>
	<tr>
 ...
 while ($rows=mysqli_fetch_assoc($getquery))
 {
	 ...
	 '<br/><i>'.' " '. $comment . ' " ' . '</i><br/>' . $dellink . '<br/>' . '<hr align="left" width="690px" />';
 }
 ?>
</div>
<div class="clear"></div>
